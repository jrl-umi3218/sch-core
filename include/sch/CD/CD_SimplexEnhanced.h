...
namespace sch
{
class CD_SimplexEnhanced : public CD_Simplex
{
public:
  ...
  SCH_API CD_SimplexEnhanced(const Point3 & p1,
                             const Point3 & p2,
                             const Point3 & p3,
                             Scalar norm1,
                             Scalar norm2,
  ...
  /*!
   * \brief optimized version of GetClosestSubSimplex((0,0,0),v) for GJK (the highest index point is the last inserted
   *in the GJK algorithm) to make it work, updateVectors must be called before.
   */
