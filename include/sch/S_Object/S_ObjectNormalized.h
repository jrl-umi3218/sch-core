...
namespace sch
{
class S_ObjectNormalized : public S_Object
{
public:
  ...
  /*!
   *  \brief put the vector NORMALIZED it in objects coordinates, then calls l_support. DO NOT OVERLOAD IT UNLESS YOU
   * KNOW WHAT YOU ARE DOING (if you want to define the support function, overload l_support) \param v direction vector
