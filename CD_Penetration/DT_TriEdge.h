...
public:
    ...
    bool silhouette(const Vector3 *verts, Index_t index, TriangleStore& triangleStore) const;
...
public:
    ...
    bool silhouette(const Vector3 *verts, Index_t index, TriangleStore& triangleStore); 
...
public:
	...
	Triangle *newTriangle(const Vector3 *verts, Index_t i0, Index_t i1, Index_t i2) 
	{ 
