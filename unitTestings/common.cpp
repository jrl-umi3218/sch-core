...
# ifdef OUTPUT_FILE
	std::fstream outfile;
	outfile.open("/tmp/randomtestsupport_result.txt",std::ios_base::out|std::ios_base::trunc);
	outfile.precision(18);
...
#ifdef OUTPUT_FILE
	std::fstream outfile;
	outfile.open("/tmp/precisiontestresult.txt",std::ios_base::out|std::ios_base::trunc);
	outfile.precision(18);
#endif
