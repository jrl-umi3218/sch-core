...
void S_Object::setOrientation(const Scalar & r00,
                              const Scalar & r01,
                              const Scalar & r02,
                              const Scalar & r10,
                              const Scalar & r11,
...
{
  ++stamp_;
  mRot_.Set(r00, r01, r02, r10, r11, r12, r20, r21, r22);
}
...
void S_Object::addRotation(const Scalar & r00,
                           const Scalar & r01,
                           const Scalar & r02,
                           const Scalar & r10,
                           const Scalar & r11,
...
{
  ++stamp_;
  Matrix3x3 m(r00, r01, r02, r10, r11, r12, r20, r21, r22);
  mRot_ = m * mRot_;
  trans_ = m * trans_;
}
...
{
  ++stamp_;
  setOrientation(t(0, 0), t(0, 1), t(0, 2), t(1, 0), t(1, 1), t(1, 2), t(2, 0), t(2, 1), t(2, 2));
