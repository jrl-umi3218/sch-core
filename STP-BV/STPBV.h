...
public:
	...
	virtual STPBV & operator=(const STPBV&);
	...
	/*!
	 *  \brief Constructs the object from a file describing its stpbv decomposition
	 *  \param filename path to the file describing the stpbv decomposition of the object
	 *
	...
	/*!
	 *  \brief Constructs the object from a file describing its stpbv decomposition and a file describing 
	 * its tree structure for the distance calculation method based on a tree.
	 *  \param filename path to the file describing the stpbv decomposition of the object
	 ...
	 *
	 * This method only computes the data needed for display and simple distance calculation methods. The tree
	 * needed for the last method is loaded directly from the treefilename file. It uses a Boost serializer to do so.
	 */
	void constructFromFile(const std::string& filename, const std::string& treefilename, ArchiveType type = TEXT_ARCHIVE);
